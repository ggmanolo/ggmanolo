    ...
    <Section id="who" className={s["who-section"]}>
      ...
      <article className={s.description}>
        ...
        <p>
          ...
          frameworks like React and Next.js. Experienced in building responsive
          and mobile-friendly web applications that deliver exceptional user
          experiences. I am dedicated to creating pixel-perfect designs that are
